...
function TeamHiredReqs ( {currentTeam}) {
    ...
    return (
      <div className='req-container'>
        <Table sortable celled fixed>
          ...
          <Table.Body>
            {data.map(({ req_id, name, org, recruiter, hiring_manager, open_date, hire_goal, hired_status, hired_date, candidate, candidate_app }) => (
